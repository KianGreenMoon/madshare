...
> by no CSS rule at all), which is now the only open UI bug. It is a *missing
> rule*, not a regression: it predates both fixes and neither touched it.
