...
# The scenarios: real meshes under real faults. ~7 min, serial, verbose.
# Unfiltered on purpose: -run Chaos is NOT the whole gated set (some gated
# tests, e.g. TestStaleHoldersCostAFetch, do not carry Chaos in their name).
MADSHARE_CHAOS=1 go test -p 1 -v ./federation/...
